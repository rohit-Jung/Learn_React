...
function Eyes() {
  ...
  return (
    <div className="relative w-full h-screen bg-[url('https://ochi.design/wp-content/uploads/2022/05/Top-Viewbbcbv-1-1440x921.jpg')] bg-no-repeat bg-center bg-cover">
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2  h-56 flex items-center gap-10">
        <div className="w-[14.5vw] h-[14.5vw] bg-gray-100 rounded-full flex justify-center items-center overflow-hidden">
          ...
          <div
            style={{ transform: `rotate(${rotatedeg}deg)`, position: 'absolute' }}
