...
function Footer() {
  return (
    <div className="bg-[#F1F1F1] w-full h-screen px-16 py-14 flex">
      <div className="w-1/2 flex flex-col justify-between">
        <h1 className="text-[8.4vw] leading-[6.3vw] font-['Founders_Grotesk_X'] font-bold uppercase">
          eye- <br />
          opening{" "}
        </h1>
        <svg
      ...
      <div className="w-1/2 flex flex-col">
        ...
        <div className="w-full flex font-['Neue_Montreal_Regular']">
          <div className="w-2/3 flex flex-col items-start justify-between  py-5 h-[78vh]">
            ...
            <p className="text-gray-500">
              &copy; ochi design 2024. Legal Terms
            </p>
          </div>
